...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.cronJob }}
...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.deployment }}
...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.statefulSet }}
...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.ingress }}
...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.pdb }}
...
{{- if .Values.global }}
{{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.traefik }}
...
{{- if .Values.global }}
  {{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.istioGateway }}
...
{{- if .Values.global }}
  {{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.istioVirtualService }}
...
{{- if .Values.global }}
  {{- if and (hasKey .Values.global "apiVersions") .Values.global.apiVersions.istioDestinationRule }}
