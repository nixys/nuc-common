...
{{- end }}
{{- if .Values.generic }}
  {{- if hasKey .Values.generic "labels" }}
...
{{- if $.Values.generic }}
  {{- if hasKey $.Values.generic "extraSelectorLabels" }}
...
{{- if .Values.generic }}
  {{- if hasKey .Values.generic "annotations" }}
...
{{- .Values.defaultURL -}}
{{- else if and .Values.global .Values.global.defaultURL -}}
{{- .Values.global.defaultURL -}}
{{- end -}}
{{- end -}}
